...
<div class=" col-lg-2 col-md-2 col-xs-4 pull-right margin-bottom-10 padding-right-0 ">
			...
			<li id="menu1" class="active"><a href="#faq-tab-1"
				data-toggle="tab">图表呈现</a></li>
			<li id="menu2"><a href="#faq-tab-2" data-toggle="tab">表格呈现</a></li>
		</ul>
		...
		<div class="tab-content no-border padding-24">
			...
			<div id="faq-tab-1" class="tab-pane fade  in active">
				<div id="pchart" data-options="region:'east'"
