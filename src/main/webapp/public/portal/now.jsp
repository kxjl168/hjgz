...
<body id="ngSection" ng-app="myApp" ng-controller="eduCtrl">
	...
	<div class="" id="content" style="">
		...
		<div class="center row margin-top-52">
			...
			<div class="  " style="min-height: 500px;">
				...
				<div id="pgdiv" name="pgdiv" class="col-sm-12 col-xs-12 nopaddding ">
					...
					<div class="tcenter title row col-xs-12 nopaddding  ">
						<span class="back glyphicon glyphicon-chevron-left"></span> 实时监控
					</div>
					...
					<div class=" row listdiv dtab">
						...
						<ul class="nav nav-tabs" id="myTab">
							...
							<li class="col-xs-2 p25  active"><a href="#identifier1"
								data-toggle="tab">所有</a></li>
							<li class="col-xs-2 p25 "><a href="#identifier2"
								data-toggle="tab">预警</a></li>
							<li class="col-xs-2 p25 "><a href="#identifier3"
								data-toggle="tab">告警</a></li>
							<li class="col-xs-2 p25 "><a href="#identifier4"
								data-toggle="tab">离线</a></li>
						...
						<div class="tab-content">
							...
							<div class="row tab-pane active " id="identifier1">
								...
								<div class=" col-lg-12 margin-top-5">
									...
									<div ng-cloak ng-repeat="item in datalist1"
										class="nleft col-xs-6  ">
										<div class="nimgdiv " ng-click="showdetail(item)">
											<div class="nowcircle">
												<div class="wtop">{{item.title}}</div>
												<i class="wenduji {{item.img}}"></i>
												<div class="wnum">
													{{item.prenum}}<span class="wnum2"><span>.{{item.endnum}}</span>°C</span>
												</div>
											</div>
											<img></img>
										</div>
							...
							<div class="row tab-pane " id="identifier2">
								...
								<div class=" col-lg-12 margin-top-5">
									...
									<div ng-cloak ng-repeat="item in datalist2"
										class="nleft col-xs-6  ">
										<div class="nimgdiv " ng-click="showdetail(item)">
											<div class="nowcircle">
												<div class="wtop">{{item.title}}</div>
								...
								<div class="row tab-pane " id="identifier3">
									...
									<div class=" col-lg-12 margin-top-5">
										...
										<div ng-cloak ng-repeat="item in datalist3"
											class="nleft col-xs-6  ">
											<div class="nimgdiv " ng-click="showdetail(item)">
												<div class="nowcircle">
													<div class="wtop">{{item.title}}</div>
								...
								<div class="row tab-pane " id="identifier4">
									...
									<div class=" col-lg-12 margin-top-5">
										...
										<div ng-cloak ng-repeat="item in datalist4"
											class="nleft col-xs-6  ">
											<div class="nimgdiv " ng-click="showdetail(item)">
												<div class="nowcircle">
													<div class="wtop">{{item.title}}</div>
			...
			<script
				src="<c:out value="${basePath}"/>/js/plugin/echart/echarts.js"></script>
			<script type="text/javascript"
				src="${basePath}/public/portal/time.js"></script>

			<script type="text/javascript"
				src="${basePath}/public/portal/chart.js"></script>

			<!-- <script type="text/javascript" src="${basePath}/js/plugin/select2/select2.full.min.js"></script>  -->
			<script type="text/javascript" src="${basePath}/public/portal/now.js"></script>
</body>
</html>