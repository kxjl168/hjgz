...
<input type="hidden" id="index" value="${index }"/>
		...
		<span class="back glyphicon glyphicon-chevron-left"></span>	待处理
			</div>	
					...
					<div class=" row listdiv dtab">
						...
						<ul class="nav nav-tabs" id="myTab">
										...
										<li class="col-xs-2 p25 active"><a href="#identifier1" data-toggle="tab">待处理</a></li>
										<li class="col-xs-2 p25"><a href="#identifier2" data-toggle="tab">预警</a></li>
										<li class="col-xs-2 p25"><a href="#identifier3" data-toggle="tab">告警</a></li>
										<li class="col-xs-2 p25"><a href="#identifier4" data-toggle="tab">离线</a></li>
	...
	<script type="text/javascript" src="${basePath}/public/portal/todo.js"></script>
